...
(
    ...
    // * Localparams
    // * ----------------------------------------------------------------------------------------------
    localparam                                                                  NB_SUM_FORWARD   = 10 ;
    localparam                                                                  NB_FRAC          =  4 ;

    // * ----------------------------------------------------------------------------------------------
    // * Internal logics
    // * ----------------------------------------------------------------------------------------------
    logic  signed       [ N_INPUT_SAMPLES  - 1 : 0 ] [ NB_DATA_IN     - 1 : 0 ] x_samples             ;
    logic  signed       [ N_INPUT_SAMPLES  - 1 : 0 ] [ NB_SUM_FORWARD - 1 : 0 ] partial_sums_x        ;
    ...
    assign ed_result = {partial_sums_x[N_INPUT_SAMPLES-1], {NB_FRAC{1'b0}}} + partial_sums_y[N_OUTPUT_SAMPLES-1];
